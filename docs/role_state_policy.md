...
- **guest**: 로그인하지 않았거나, 가입/온보딩이 완료되지 않은 사용자 상태
- **member**: 가입이 완료되어 정상적으로 서비스를 이용할 수 있는 상태
...
- guest는 로그인하지 않았거나 가입/온보딩이 완료되지 않은 상태이다.
- guest는 서비스의 제한된 체험/읽기 범위 내에서만 기능을 이용할 수 있다.
- guest가 가입/온보딩을 완료하면 member로 전환된다.

### **4.2 member**

- member는 가입이 완료되어 정상적으로 서비스를 이용할 수 있다.
- member는 본인 계정에 대한 **탈퇴(삭제 요청)** 를 할 수 있다.
