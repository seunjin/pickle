    ...
    <div className="mx-auto max-w-3xl px-6 py-20">
      ...
      <section className="prose prose-slate dark:prose-invert max-w-none">
        ...
        <ul className="list-disc space-y-1 pl-5 text-gray-600 dark:text-gray-400">
          ...
          <li>위치 정보(GPS 등)</li>
          <li>
            웹 기록(방문 페이지 목록, 방문 시간 등) 및 사용자 활동(키
            입력/마우스 이동/스크롤 추적 등)
          </li>
        </ul>
        ...
        <ul className="list-disc space-y-1 pl-5">
          <li>
            사용자가 저장한 콘텐츠를 보관하고, 확인·정리·관리 기능을 제공하기
            위해
          </li>
        </ul>
        ...
        <ul className="list-disc space-y-2 pl-5">
          <li>
            서비스는 이용자 데이터를 제3자에게 판매하지 않으며, 승인된 사용
            사례를 제외하고 전송 또는 제공하지 않습니다.
          </li>
          <li>
            서비스는 신용도 판단 또는 대출 목적을 위해 이용자 데이터를
            사용하거나 전송하지 않습니다.
          </li>
        </ul>
        ...
        <p>
          서비스는 이용자 데이터 보호를 위해 합리적인 보호 조치를 적용합니다.
        </p>
